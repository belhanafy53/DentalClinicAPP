    ...
    public partial class FormsUserTypeUserFrm : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            if (Program.GlbV_Language == "en")
            {
                if (comboBox1.SelectedItem.ToString() == "")
                {
                    MessageBox.Show("Please Choose system unite ");
                    comboBox1.Focus();
                }
                else if (comboBox2.SelectedItem.ToString() == "")
                {
                    MessageBox.Show("Please Choose Users Type ");
                    comboBox2.Focus();
                }
                else
                {
                    ...
                    //{
                        ...
                        //splashScreenManager1.SetWaitFormCaption(" Distribution Authintications  ");
                        ...
                        for (int i = 0; i < dataGridView1.Rows.Count; i++)
                        {
                            ...
                            foreach (TreeListNode item in nodes)
                            {
                                ...
                                if (listform.Forms_ID != null)
                                {
                                    ...
                                    dataGridView2.Columns["Name"].HeaderText = "Procedure";
                    ...
                    //else
                    //{
                    //    MessageBox.Show("Don't have Authority at this Form");
                    //}
                }
            }
